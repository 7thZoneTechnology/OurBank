...
class Fee_Model_Fee extends Zend_Db_Table 
{
    ...
    public function getFee($id) 
	{
        $select=$this->select()
                ...
                ->join(array('a'=>'ourbank_fee'),array('id'),array('a.description as feedescription','name','value','glsubcode_id','membertype_id'))
                ->where('a.id=?',$id)
				->join(array('b' => 'ourbank_master_membertypes'),'a.membertype_id = b.id','name as type')
