...
<?php
class Savingsdetails_IndexController extends Zend_Controller_Action {
	public function init() {
		$this->view->pageTitle='Personal savings members';
$this->view->type = "others";
	...
	public function indexAction() {
		    $personalsavings = new Savingsdetails_Model_Savingsdetails();
