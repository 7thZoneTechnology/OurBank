...
->join(array('d' => 'ourbank_groupmembers'),'d.group_id  = a.id',array('member_id'))
	...
	public function getlocation($id){ 
		...
		->join(array('d' => 'ourbank_agriculture'),'d.family_id  = c.family_id')
		->join(array('e' => 'ourbank_loanprocess'),'e.member_id  = c.family_id')
		->join(array('f' => 'ourbank_master_loanpurpose'),'e.purpose  = f.id',array('name as purposename'))
		->join(array('g' => 'ourbank_master_villagelist'),'g.id  = c.village_id',array('name as bank') );
	//die($select->__toString($select));
