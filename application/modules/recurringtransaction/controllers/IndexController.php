    ...
    function recurringAction()
    {
       ...
       echo $this->view->productid=$productId;
        ...
        foreach($recurringmemberbranchid as $recurringmemberbranchids) {
            $memberbranch_id=$this->view->memberbransch_id=$recurringmemberbranchids['bank'];
        }
...
echo $InstalmentNumber;
    ...
    function recurringsAction()
    {
        ...
        $this->view->recurringmemberbranchid = $recurringmemberbranchid;
        foreach($recurringmemberbranchid as $recurringmemberbranchids) {
            $memberbranch_id=$this->view->memberbranch_id=$recurringmemberbranchids['bank'];
        }
...
// 
        ...
        function statusAction()
        {
            ...
            $date = new Zend_Date();
            if ($this->_request->getPost('Confirm') || $this->_request->getPost('Submit')) { 
                /*if the data is Posted*/
                echo $accountId=$this->_request->getPost('accountId');
                echo $productId=$this->_request->getPost('productId');
...
//                 $totalnumberofinstallments=count($numberofinstallments);
                ...
                if ($this->_request->isPost() && $this->_request->getPost('Confirm')) {
                    ...
                    if ($RecurringstatusForm->isValid($formData)) {
                        ...
                        $accountId =$this->view->accountId= $this->_request->getParam('accountId');
                        $productId =$this->view->productId= $this->_request->getParam('productId');
