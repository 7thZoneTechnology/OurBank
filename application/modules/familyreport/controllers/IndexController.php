...
############################################################################
*/
class Familyreport_IndexController extends Zend_Controller_Action
{
    public function init()
    {
        $this->view->pageTitle =$this->view->translate("Family Report");
...
//index action call individual index page...
    ...
    {
		$this->view->form = new Familyreport_Form_Search();
		$family = new Familyreport_Model_Familyreport();
        ...
        if ($this->_request->isPost() && $this->_request->getPost('Search')) {
             $formData = $this->_request->getPost();
                 if ($this->view->form->isValid($formData)) {
                    ...
                    $this->view->gilla_id = $gilla_id = $this->_request->getParam('gramapanchayat');

					$this->view->result = $family->fetchDetails($gilla_id);
