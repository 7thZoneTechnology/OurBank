...
class groupgrading_IndexController extends Zend_Controller_Action 
{
    ...
    {
       $accountsForm = $this->view->form = new groupgrading_Form_Search();
    ...
    public function addAction()
    {
        ...
        //if ($this->_request->isPost()) 
        {
            ...
            $this->_redirect('/groupgrading/index');
        }
    }
		...
		if ($accountsForm->isValid($formData)) {
                    ...
                    if($Activemembers){
                     echo "You have already requested loan";
                      ...
                      if (substr($membercode,4,1) == 2 || substr($membercode,4,1) == 3) {
                            ...
                            $addForm = new groupgrading_Form_Loanprocess(count($this->view->group));
                    ...
                    $this->view->appform = new groupgrading_Form_Application();
    ...
    {
        $jlgForm = $this->view->form = new groupgrading_Form_Jlgadvances();
