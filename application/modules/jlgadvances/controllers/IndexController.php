...
<?php
class Jlgadvances_IndexController extends Zend_Controller_Action
{
	public function init() 
	{
		 $this->view->pageTitle=$this->view->translate('Jlgadvances');
...
// 						$id = $this->view->adm->addRecord("ourbank_fee",$form->getValues());
...
// 					//update 					
// 					$this->view->adm->updateRecord("ourbank_fee",$id,$form->getValues());
// 			$this->_redirect("/fee");
// 	
// 			}
// 		} else {
